...
export const getHoroscope = (date: string | Date): string => {
    ...
    const signDates = [
        ...
        {sign: "Scorpius", start: [10, 24], end: [11, 21]},
        {sign: "Sagittarius", start: [11, 22], end: [12, 21]},
        {sign: "Capricornus", start: [12, 22], end: [1, 19]},
        {sign: "Aquarius", start: [1, 20], end: [2, 18]},
        {sign: "Pisces", start: [2, 19], end: [3, 20]},
    ]

    for(const item of signDates){
...
export const getChineseZodiac = (date: string | Date): string => {
    const birthDate = new Date(date);

    for(const item of chineseZodiac){
